...
import { FaUsers, FaEnvelope, FaPhone, FaUserTag, FaChartLine, FaTasks, FaShieldAlt } from 'react-icons/fa';
  ...
  return (
    <div className="container mx-auto p-6">
      ...
      <section className="mb-8">
        ...
        <div className="bg-white p-6 rounded-lg shadow-md flex justify-center items-center" style={{ maxWidth: '900px', margin: '0 auto' }}>
      ...
      {/* Sección de Progreso */}
        <section className="mb-8">
          <h2 className="text-3xl font-semibold mb-4 flex items-center text-yellow-600">
      ...
      {/* Sección de Equipo */}
      <section className="mb-8">
      <Link to="/equipo" className="text-3xl font-semibold mb-4 flex items-center text-blue-700 hover:underline">
